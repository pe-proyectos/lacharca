  ...
  return (
    <div className="flex gap-3 px-4 py-3 border-b border-white/[0.06]">
      {user.avatarUrl
        ...
        : <div className="w-10 h-10 rounded-full flex items-center justify-center text-[15px] font-medium shrink-0" style={{ background: "#dbe8fb", color: "var(--blue)" }}>{(user.displayName || user.handle)[0]?.toUpperCase()}</div>}
